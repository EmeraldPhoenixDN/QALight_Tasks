...
{
    public class Atlas : Helicopter
    {
        public Atlas (string typeOfHelicopter, int maxSpeed, int maxHeight, int yearOfIssue) : base(typeOfHelicopter, maxSpeed, maxHeight, yearOfIssue)
        {
